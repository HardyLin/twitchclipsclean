...
//         let time_key = Object.keys(duplicateIndex_[key]);
//         for (let k = 0; k < duplicateIndex_[key][time_key].length; k++) {
//             allRows[duplicateIndex_[key][time_key][k]].querySelector('.tw-checkbox__label').click();
//             console.log(duplicateIndex_[key][time_key][k]);
//         }
